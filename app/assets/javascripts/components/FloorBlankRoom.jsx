...
var FloorBlankRoom = React.createClass({
	...
	componentDidMount: function(){
		...
		// this.setState({'x': this.props.x, 'y': this.props.y, 'label': this.props.label});
		...
		$(this.refs.roomBody).hammer().bind("press", function(ev) {
			...
			_this.props._pOpenModal(_this.props.index);
		});
	...
	_nextStatus: function(){
		var icon = this.props._pNextRoomStatus(this.props.index, this.props.status);
